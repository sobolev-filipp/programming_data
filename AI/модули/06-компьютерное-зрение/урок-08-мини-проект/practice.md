...
> ### 📊 Как читать эту сетку картинок (классы датасета)
>
> **Зачем она нужна.** Перед обучением увидеть, какие классы предстоит различать и как они выглядят.
>
> **Что на картинке.** 3 картинки в ряд — по одному примеру каждого класса, над каждой её метка (paper / rock / scissors).
>
> **Что мы видим.** Три жеста руки: раскрытая ладонь (бумага), кулак (камень), два пальца (ножницы).
>
> **Какой вывод.** Классы визуально различимы, но бумага и ножницы похожи (обе — «раскрытая рука»), а камень (кулак) стоит особняком. Запомним это: скорее всего, модель будет путать именно бумагу с ножницами — проверим по матрице ошибок в конце.
...
> ### 📊 Как читать матрицу ошибок (картинкой)
>
> **Зачем она нужна.** Точность 94% не говорит, ЧТО с чем путается. Матрица ошибок раскладывает предсказания по клеткам и показывает конкретные путаницы.
>
> **Что на картинке.** Сетка 3×3. По вертикали (Y) — истинный класс, по горизонтали (X) — что предсказала модель. В каждой клетке — число объектов (`plt.text`), а цвет (`cmap='Blues'`, шкала `colorbar`) тем темнее, чем число больше.
>
> **Что мы видим.** Диагональ тёмная (правильные ответы). Одна тёмная клетка ВНЕ диагонали — там, где истина «бумага», а предсказание «ножницы» (19 раз).
>
> **Какой вывод.** Диагональ = верные ответы, клетки вне неё = ошибки. Тёмная клетка бумага→ножницы подтверждает нашу догадку с самого начала: похожие жесты путаются. Камень (кулак) распознаётся идеально — его строка чистая. Так матрица показывает не «сколько ошибок», а «какие именно» — и куда направить улучшения.
