...
## Часть 4 — Даём голос: озвучка и постановка звука (10 минут)

Теперь маскот заговорит. Нужен короткий звук — например «Привет! Меня зовут Бип».

### 🤖 Шаг 0. Получаем голос — нейросеть-озвучка (вне Animate)

Микрофона нет? Не беда — пусть **фразу озвучит нейросеть** по тексту, а мы скачаем готовый MP3. Это внешний помощник (🤖) **вне Adobe** — по правилам курса так можно (в самой Animate ИИ не используем, только импортируем готовый звук, как обычный файл).

1. Открой сайт-озвучку (см. «Материалы» ниже, напр. **TTSMaker**) → выбери язык **Русский** и **голос** (мужской/женский/детский).
2. Впиши **текст реплики** маскота (например, «Привет! Меня зовут Бип»).
3. Нажми **«Озвучить»** → послушай → **«Скачать MP3»**. Сохрани файл `privet.mp3` в папку проекта.
   - 👀 **Что получишь:** готовый аудиофайл с речью — как будто это записанный голос.

> 💡 **Свой голос — по желанию.** Если дома/у кого-то есть телефон или микрофон — можно записать **свой** голос (диктофон → перекинь файл) и взять его вместо нейросети. Оба варианта подходят.
...
> 🔊 **Где взять голос:** 🤖 **нейросеть-озвучка по тексту** (основной способ, без микрофона) — [TTSMaker](https://ttsmaker.com/) (рус. голоса, без регистрации, скачать MP3), [ttsMP3.com](https://ttsmp3.com/text-to-speech/Russian/), [Luvvoice](https://luvvoice.com/). Или **свой голос** (диктофон телефона), или готовые «hi/hello» на [Pixabay Sound](https://pixabay.com/sound-effects/), [Mixkit](https://mixkit.co/free-sound-effects/), [Freesound](https://freesound.org/).
...
**📥 Материалы (свободные):**
- 🤖 **Голос маскота — нейросеть-озвучка по тексту** (основной способ, микрофон не нужен): [TTSMaker](https://ttsmaker.com/) (рус. голоса, без регистрации, скачать MP3, ~20 000 знаков/нед бесплатно), [ttsMP3.com](https://ttsmp3.com/text-to-speech/Russian/) (простой, русский → MP3), [Luvvoice](https://luvvoice.com/) (70+ языков, MP3). Впиши фразу → выбери русский голос → скачай MP3. *(Это внешний помощник вне Adobe — по правилам курса можно; в самой Animate ИИ не используем.)*
- 🔊 **Свой голос (по желанию)** — если есть телефон/микрофон: диктофон → перекинь файл. Или готовые «hi/hello» на [Pixabay Sound](https://pixabay.com/sound-effects/), [Mixkit](https://mixkit.co/free-sound-effects/), [Freesound](https://freesound.org/).
