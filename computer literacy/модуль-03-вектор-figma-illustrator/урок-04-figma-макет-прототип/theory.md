...
3. Между названием и временем поставь распор: выдели **текст-название** → справа в панели Design найди поле **ширины (W)**, кликни выпадающий список рядом с ним и выбери **«Fill container»** (растянуть). 👀 Название раздвинет строку, и время прижмётся к **правому** краю. Аккуратная строка!
