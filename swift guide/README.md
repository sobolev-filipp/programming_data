...
<br/>
<a name="create_app"></a>
<h2>Создание первого IOS приложения</h2>
...
<a name="controls"></a>
<h2>Контроль потока выполнения (ветвления)</h2>
...
<br/>
<a name="picker"></a>
<h2>Что такое UIPickerView и зачем он нужен?</h2>
